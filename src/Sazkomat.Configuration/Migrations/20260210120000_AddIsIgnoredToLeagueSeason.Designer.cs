...
namespace Sazkomat.Configuration.Migrations
{
    ...
    [Migration("20260210120000_AddIsIgnoredToLeagueSeason")]
    partial class AddIsIgnoredToLeagueSeason
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sazkomat.Configuration.Entities.DataProvider", b =>
                {
                    ...
                    b.Property<string>("ScanCapabilities")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
            ...
            modelBuilder.Entity("Sazkomat.Configuration.Entities.LeagueSeason", b =>
                {
                    ...
                    b.Property<DateTime?>("LastRecipeTestedAt")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.Property<Guid?>("LastSuccessfulRecipeId")
                        .HasColumnType("uuid")
